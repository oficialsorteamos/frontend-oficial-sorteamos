  ...
  tasks: [
    {
      ...
      dueDate: '2020-11-25',
      description:
        'Chocolate cake topping bonbon jujubes donut sweet wafer. Marzipan gingerbread powder brownie bear claw. <br> Chocolate bonbon sesame snaps jelly caramels oat cake.',
      assignee: {
...
// GET: Return Tasks
// ------------------------------------------------
mock.onGet('/apps/chatbot/tasks').reply(config => {
...
// POST: Add new task
// ------------------------------------------------
mock.onPost('/apps/chatbot/tasks').reply(config => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost(/\/apps\/chatbot\/tasks\/\d+/).reply(config => {
...
// DELETE: Remove Task
// ------------------------------------------------
mock.onDelete(/\/apps\/chatbot\/tasks\/\d+/).reply(config => {
