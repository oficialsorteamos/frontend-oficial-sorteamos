<template>
  <div class="sidebar-wrapper d-flex justify-content-between flex-column flex-grow-1">
    <div class="p-2">
      ...
      >
        {{ $t('calendar.calendarSidebar.addEvent') }}
      </b-button>
      <div class="mt-3">
        <h5 class="app-label section-label mb-1">
          <span class="align-middle">{{ $t('calendar.calendarSidebar.tags') }}</span>
        </h5>
        <b-form-checkbox
          v-model="checkAll"
          class="mb-1"
        >
          {{ $t('calendar.calendarSidebar.viewAll') }}
        </b-form-checkbox>
        <b-form-group>
          ...
          >
            <b-form-checkbox
              ...
              class="mb-1"
              checked
              :style="`background_color:${item.tag_color}`"
            >
              {{ item.tag_name }}
            </b-form-checkbox>
          </b-form-checkbox-group>
