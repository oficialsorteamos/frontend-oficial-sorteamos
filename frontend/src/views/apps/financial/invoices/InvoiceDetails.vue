        ...
        >
            ...
            <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
              ...
              <div class="mt-md-0 mt-2">
                <h4 class="invoice-title">
                  ...
                  <span class="invoice-number">{{ invoiceData.inv_month_year }}</span>
                </h4>
                <div class="invoice-date-wrapper">
                  ...
                  <p class="invoice-date">
                    {{ formatDateOnlyNumber(invoiceData.inv_opening) }}
                  </p>
                </div>
                <div class="invoice-date-wrapper">
                  <p class="invoice-date-title">
                  ...
                  <p class="invoice-date">
                    {{ formatDateOnlyNumber(invoiceData.inv_closing) }}
                  </p>
                </div>
                <div class="invoice-date-wrapper">
                  <p class="invoice-date-title">
                  ...
                  <p class="invoice-date">
                    {{ formatDateOnlyNumber(invoiceData.inv_due) }}
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <template #cell(inv_total_value_fee)="data">
              R$ {{ data.item.inv_total_value_fee.replace('.', ',') }}
            </template>
          </b-table-lite>
