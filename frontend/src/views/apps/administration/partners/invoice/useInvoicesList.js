...
export default function useUsersList() {
  ...
  const tableColumns = [
    ...
    { key: 'par_month_year', label: 'Mês/Ano'},
    { key: 'par_closing', label: 'Fechamento' },
    { key: 'par_due', label: 'Vencimento' },
  ...
  watch([categoryFilter, perPage, currentPage, statusFilter, partnerFilter], () => {
    //Aplica o filtro
