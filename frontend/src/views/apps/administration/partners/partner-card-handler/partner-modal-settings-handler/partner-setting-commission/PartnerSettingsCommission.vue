        ...
        <b-row>
          <b-col sm="4">
              ...
              <validation-provider
                ...
                :name="$t('partner.partnerSettingsCommission.commission')"
                rules="required"
              >
                <b-form-group
                  :label="$t('partner.partnerSettingsCommission.commission')"
                  label-for="account-name"
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_percentage_level_1"
            ...
            <b-col sm="4">
              ...
              <validation-provider
                #default="validationContext"
                :name="$t('partner.partnerSettingsCommission.initialQuantity')"
                rules="required"
              >
                <b-form-group
                  :label="$t('partner.partnerSettingsCommission.initialQuantity')"
                  label-for="account-name"
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_initial_quantity_level_1"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
            ...
            <b-col sm="4">
              ...
              <validation-provider
                #default="validationContext"
                :name="$t('partner.partnerSettingsCommission.finalQuantity')"
                rules="required"
              >
                <b-form-group
                  :label="$t('partner.partnerSettingsCommission.finalQuantity')"
                  label-for="account-name"
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_final_quantity_level_1"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
            ...
            <b-col sm="4">
              ...
              >
                ...
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_percentage_level_2"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
            ...
            <b-col sm="4">
              ...
              >
                ...
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_initial_quantity_level_2"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
            ...
            <b-col sm="4">
              ...
              >
                ...
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_final_quantity_level_2"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
            ...
            <b-col sm="4">
              ...
              >
                ...
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_percentage_level_3"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
            ...
            <b-col sm="4">
              ...
              >
                ...
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_initial_quantity_level_3"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
            ...
            <b-col sm="4">
              ...
              >
                ...
                >
                  <b-form-input
                    id="plan-total-user"
                    v-model="settingsLocal.commission.par_final_quantity_level_3"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    type="text"
...
import usePartnerSettingCommission from './usePartnerSettingCommission'
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const {
      ...
      // UI
      onSubmit,
    } = usePartnerSettingCommission(toRefs(props), emit)
