        ...
        >
          ...
          <b-row>
            ...
            <b-col md="6">
              <validation-provider
                #default="{ errors }"
                :name="$t('partner.partnerModalHandler.typePartner')"
                rules="required"
              >
                <b-form-group
                  :label="$t('partner.partnerModalHandler.typePartner')+'*'"
                  label-for="vue-select"
                  :state="errors.length > 0 ? false:null"
                >
                  <v-select
                    id="vue-select"
                    v-model="partnerLocal.type_partner"
            ...
            <b-col md="4">
              <validation-provider
                ...
                :name="$t('partner.partnerModalHandler.partnershipStarted')"
                rules="required|min:10"
              >
                <b-form-group
                  :label="$t('partner.partnerModalHandler.partnershipStarted')"
                  label-for="contact-birthday"
                >
                  <b-form-input
                    id="contact-birthday"
                    v-model="partnerLocal.par_partnership_started"
          ...
          <b-row>
            ...
            <b-col md="8">
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="partnerLocal.par_corporate_name"
                    id="user-name"
                    :state="getValidationState(validationContext)"
                    trim
                    type="text"
            ...
            >
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="partnerLocal.par_responsible_name"
                    id="user-name"
                    :state="getValidationState(validationContext)"
                    trim
                    type="text"
            ...
            >
              ...
              >
                ...
                >
                  <b-form-input
                    id="contact-birthday"
                    v-model="partnerLocal.par_birthday"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    v-mask="'##/##/####'"
            ...
            <b-col md="6">
              <input
                type="hidden"
                id="phoneNumber"
                v-bind:value="partnerLocal.phoneNumber = phoneNumber"
              />
              <validation-provider
                #default="{ errors }"
              ...
              >
                ...
                >
                  <!-- Phone Number -->
                  <VuePhoneNumberInput  
                    v-model="partnerLocal.par_responsible_phone"
                    :required="true"
                    class="mb-1"
            ...
            <b-col md="6">
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="partnerLocal.par_responsible_email"
                    id="user-email"
                    :state="getValidationState(validationContext)"
                    trim
            ...
            <b-col md="6">
              <input
                type="hidden"
                id="phoneNumber"
                v-bind:value="partnerLocal.financialPhoneNumber = phoneNumber"
              />
              <validation-provider
                #default="{ errors }"
              ...
              >
                ...
                >
                  <!-- Phone Number -->
                  <VuePhoneNumberInput  
                    v-model="partnerLocal.par_finance_phone"
                    :required="true"
                    class="mb-1"
                    @update="setPhoneNumber"
                  />
            ...
            <b-col md="6">
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="partnerLocal.par_finance_email"
                    id="user-email"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder="example@email.com"
          ...
          <b-row>
            ...
            <b-col md="12">
              <validation-provider
                #default="validationContext"
                :name="$t('administrationCompany.companyModalHandler.url')"
                rules="min:5"
              >
                <b-form-group
                  label-for="user-name"
            ...
            <b-col md="3">
              ...
              >
                ...
                >
                  <b-form-input
                    id="address-cep"
                    v-model="partnerLocal.par_postal_code"
                    autofocus
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    v-mask="'#####-####'"
                    :maxlength="9"
                    @keyup="getAddressUser(partnerLocal.par_postal_code)"
                    autocomplete="off"
                  />
            ...
            <b-col md="10">
              ...
              >
                ...
                >
                  <b-form-input
                    id="address-street"
                    v-model="partnerLocal.par_address"
                    :state="getValidationState(validationContext)"
                    trim
                    :placeholder="$t('user.userModalHandler.streetPlaceholder')"
                    v-bind:value="partnerLocal.par_address = partner.par_address"
                  />
            ...
            <b-col md="2">
              ...
              >
                ...
                >
                  <b-form-input
                    id="address-number"
                    v-model="partnerLocal.par_address_number"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    v-bind:value="partnerLocal.par_address_number = partner.par_address_number"
                  />
              ...
              >
                ...
                >
                  <b-form-input
                    ...
                    v-model="partnerLocal.par_complement"
                    :state="getValidationState(validationContext)"
                    trim
                    :placeholder="$t('user.userModalHandler.addressComplementPlaceholder')"
                    v-bind:value="partnerLocal.address_complement = partner.address_complement"
                  />
            ...
            <b-col md="6">
              ...
              >
                ...
                >
                  <b-form-input
                    id="address-district"
                    v-model="partnerLocal.par_province"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    v-bind:value="partnerLocal.par_province = partner.par_province"
                  />
            ...
            <b-col md="6">
              ...
              >
                ...
                >
                  <b-form-input
                    id="address-city"
                    v-model="partnerLocal.par_city"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    v-bind:value="partnerLocal.par_city = partner.par_city"
                  />
            ...
            <b-col md="6">
              ...
              >
                ...
                >
                  <b-form-input
                    id="address-state"
                    v-model="partnerLocal.par_state"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    v-bind:value="partnerLocal.par_state = partner.par_state"
                  />
            ...
            <b-col md="6">
              ...
              >
                ...
                >
                  <b-form-input
                    id="address-country"
                    v-model="partnerLocal.par_country"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder=""
                    v-bind:value="partnerLocal.par_country = partner.par_country"
                  />
...
import usePartnerModalHandler from './usePartnerModalHandler'
  ...
  setup(props,{ emit }) {
    ...
    */
    ...
    const {
      ...
      // UI
      onSubmit,
    } = usePartnerModalHandler(toRefs(props), emit)
